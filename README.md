- Optei por delegar o cálculo da taxa de transferência ao Spring Boot para impedir cenários onde um usuário dispara o endpoint de criação de transação utilizando um valor incorreto de taxa de transferência.
